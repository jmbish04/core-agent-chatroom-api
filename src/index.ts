  ...
  <div class="container">
    ...
    <div class="grid">
      ...
      <div class="card">
        ...
        <h3 style="margin-top: 20px; margin-bottom: 10px; color: #667eea;">👥 Active Agents</h3>
        <ul class="agents-list" id="agentsList">
          <li style="color: #666; font-style: italic;">No agents connected</li>
        </ul>

        <h3 style="margin-top: 20px; margin-bottom: 10px; color: #667eea;">🔒 Active Locks</h3>
    ...
    <div class="card">
      ...
      <div class="quick-actions">
        ...
        <button onclick="unlockFile()">🔓 Unlock File</button>
        <button onclick="queryHistory()">📜 Query History</button>
        <button onclick="queryLocks()">🔍 Query Locks</button>
